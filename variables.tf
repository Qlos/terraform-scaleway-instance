...
variable "hostname" {
  type        = string
  description = "Hostname of the instance. If not set, it will be randomly generated by Scaleway."
  default     = null
}
...
variable "user_data" {
  type        = string
  description = "Inject extra script in the instance template to be run on boot"
  default     = null
}
